...
func ID(id int) predicate.RoomUser {
...
func IDEQ(id int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
...
func IDLT(id int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.RoomUser {
	return predicate.RoomUser(func(s *sql.Selector) {
