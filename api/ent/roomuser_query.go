...
func (ruq *RoomUserQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (ruq *RoomUserQuery) FirstIDX(ctx context.Context) int {
...
func (ruq *RoomUserQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (ruq *RoomUserQuery) OnlyIDX(ctx context.Context) int {
...
func (ruq *RoomUserQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (ruq *RoomUserQuery) IDsX(ctx context.Context) []int {
	ids, err := ruq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(roomuser.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.RoomUser.Query().
//		Select(roomuser.FieldCreatedAt).
//		Scan(ctx, &v)
